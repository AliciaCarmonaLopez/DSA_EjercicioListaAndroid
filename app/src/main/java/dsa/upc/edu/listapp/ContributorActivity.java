...
public class ContributorActivity extends AppCompatActivity {
    ...
    private final String TAG = ContributorActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.repo = intent.getStringExtra("repos");
        ...
        layoutManager = new LinearLayoutManager(ContributorActivity.this);
    ...
    private void doApiCall(final SwipeRefreshLayout mySwipeRefreshLayout) {
        ...
        Call<List<Contributor>> call = gitHubService.contributors(this.username, this.repo);
